...
function setupReveal() {
  const targets = [
    ...document.querySelectorAll(
      ".live-section, .feature-section, .text-grid article, .support-grid article, .timeline article, .apply-panel, .apply-pv-card, .apply-hero-card, .page-hero .container, .stream-card"
    ),
  ];
